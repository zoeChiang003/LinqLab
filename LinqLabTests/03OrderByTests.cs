    ...
    public class OrderByTests
    {
        ...
        public void OrderByWithIdTest()
        {
              ...
              new List<Sample>
          {
              ...
              new Sample{Id = 8,UserName = "Stephen",CreateTime = new DateTime(2016,7,20),Price = 200,Item = new List<int> {92, 90, 83, 78}},
            ...
            var actual = new OrderByLab().OrderByWithId();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void OrderByDescendingWithIdTest()
        {
            var expected =
               new List<Sample>
           {
            ...
            var actual = new OrderByLab().OrderByDescendingWithId();
        ...
        [TestMethod()]
        public void OrderByPriceAndThenOrderByIdTest()
        {
            var expected =
               new List<Sample>
           {
            ...
            var actual = new OrderByLab().OrderByPriceAndThenOrderById();
