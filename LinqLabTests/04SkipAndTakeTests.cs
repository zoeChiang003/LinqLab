    ...
    public class SkipAndTakeTests
    {
        ...
        public void SkipFiveDataTest()
        {
           ...
           new List<Sample>
            ...
            var actual = new SkipAndTakeLab().SkipFiveData();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void GetFiveDataTest()
        {
            var expected =
          new List<Sample>
            {
            ...
            var actual = new SkipAndTakeLab().GetFiveData();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void SkipFiveDataAndGetTwoDataTest()
        {
            var expected =
          new List<Sample>
            {
            ...
            var actual = new SkipAndTakeLab().SkipFiveDataAndGetTwoData();
